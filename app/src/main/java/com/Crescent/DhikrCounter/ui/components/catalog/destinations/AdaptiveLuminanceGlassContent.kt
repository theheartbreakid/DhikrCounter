...
import com.Crescent.DhikrCounter.ui.components.LocalAdaptiveLuminanceInterval
...
fun AdaptiveLuminanceGlassContent() {
    ...
    LaunchedEffect(layer, offsetAnimation.value, zoomAnimation.value, rotationAnimation.value) {
            ...
            Modifier
                .drawBackdrop(
                    ...
                    effects = {
                        ...
                        liquidLens(24f.dp.toPx(), size.minDimension / 2f, depthEffect = true)
                    },
