...
import com.Crescent.DhikrCounter.ui.components.catalog.components.LocalLiquidBottomTabScale
...
fun LiquidBottomTabs(
    ...
    val dockSettings = com.Crescent.DhikrCounter.ui.components.LocalDockSettings.current
            ...
            Modifier
                ...
                .drawBackdrop(
                    ...
                    effects = {
                        ...
                        liquidLens(dockSettings.refractionHeight.dp.toPx(), dockSettings.refractionAmount.dp.toPx())
                    },
                    layerBlock = {
                ...
                Modifier
                    ...
                    .drawBackdrop(
                        ...
                        effects = {
                            ...
                            blur(dockSettings.blurRadius.dp.toPx())
                            liquidLens(
                                dockSettings.refractionHeight.dp.toPx() * progress,
                                dockSettings.refractionAmount.dp.toPx() * progress
                            )
                        },
                        highlight = {
                            val progress = dampedDragAnimation.pressProgress
